...
选曲改为滑动封面，大按钮、横屏安全区和暂停面板统一接入。当前版本通过 249 项断言；16:9、20:9 模拟刘海安全区、4:3 平板尺寸的 UI 自检均通过，玩法回归仍为 204 颗、满分、0 Miss。此次没有编辑玩法核心或 Note 皮肤。实际截图、源文件职责、验证范围与手机真机待办见 [移动 UI 验收记录](MobileUIVerification.md)。
